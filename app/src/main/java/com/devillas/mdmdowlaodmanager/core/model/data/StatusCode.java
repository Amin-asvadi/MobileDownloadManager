package com.devillas.mdmdowlaodmanager.core.model.data;
...
public class StatusCode {
    ...
    public static final int STATE_RUNNING = 192;
    ...
    public static final int STATUS_WARNING_TO_RETRY = 194;
    /* This download is waiting for network connectivity to proceed */

    public static final int STATUS_WARNING_TO_NETWORK = 195;
    ...
    public static boolean inStatusInformational(int statusCode) {
