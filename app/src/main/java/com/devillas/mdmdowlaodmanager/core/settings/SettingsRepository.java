...
public interface SettingsRepository {
    ...
    boolean unmeteredConnectionOnly();

    void unmeteredConnectionOnly(boolean val);

    boolean enabledRoaming();

    void enabledRoaming(boolean val);
    ...
    void customBatteryControlValue(boolean val);
    ...
    String saveDownloadIn();

    void saveDownloadIn(String val);
    ...
    boolean browserAllowJavaScripts();

    void browserAllowJavaScripts(boolean val);
    ...
    void browserDisabledFromSystem(boolean val);
